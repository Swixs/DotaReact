    ...
    return (
        <div>
            ...
            <button className={classAbaddonPage.btnArrow} onClick={btn}>
                <FontAwesomeIcon icon={faCaretLeft} className={classAbaddonPage.arrowColor} style={{ "--fa-primary-color": "#787878", "--fa-secondary-color": "#787878", }} />
            </button>
            ...
            <button className={classAbaddonPage.btnArrowRight} onClick={btn}>
                <FontAwesomeIcon icon={faCaretRight} className={classAbaddonPage.arrowColor} style={{ "--fa-primary-color": "#757575", "--fa-secondary-color": "#757575", }} />
            </button>
