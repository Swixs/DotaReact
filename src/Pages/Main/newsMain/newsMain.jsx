...
const NewsMain = () => {
   return (
      <div className={classMain.backgroundNews}>
         <button className={classMain.firstBtnNews}>
            <div className={classMain.timeBtnNews}>15 DECEMBER 2023 Y.</div>
            <div className={classMain.titleBtnNews}>
               The Frostivus 2023 Update is Here
            </div>
            <div className={classMain.textBtnNews}>
         ...
         <button className={classMain.secondBtnNews}>
            <div className={classMain.timeBtnNews}>14 DECEMBER 2023 Y.</div>
            <div className={classMain.titleBtnNews}>
         ...
         <button className={classMain.thirdBtnNews}>
            <div className={classMain.timeBtnNews}>21 NOVEMBER 2023 Y.</div>
            <div className={classMain.titleBtnNews}>
