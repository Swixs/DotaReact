...
const HeroesInput = () => {
   ...
   return (
      <div className={classHeroesInput.box}>
         <div className={classHeroesInput.clue}>Filter heroes</div>

         <div className={classHeroesInput.text}>Attribute</div>

         <div>
            <button
               className={classHeroesInput.btnAtribute}
               onClick={onAtribute}
            >
               <img
                  className={classHeroesInput.atribute}
         ...
         <div className={classHeroesInput.text}>Complexity</div>
